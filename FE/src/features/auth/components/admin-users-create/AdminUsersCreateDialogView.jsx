...
function AdminUsersCreateDialogView({ createUserForm, onFormChange, onOpenChange, onRoleChange, onSubmit, onToggleShowConfirmPassword, onToggleShowPassword, open, showConfirmPassword, showPassword, submitting }) {
  return (
...
export { AdminUsersCreateDialogView };
